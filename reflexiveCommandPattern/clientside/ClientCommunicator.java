...
import shared.ResultTransferObject;
...
public class ClientCommunicator {
    ...
    public Object send(String methodName, String[] parameterTypeNames, Object[] parameters) {
        HttpURLConnection connection = openConnection("/command");
        sendToServer(connection, methodName, parameterTypeNames, parameters);
    ...
    private void sendToServer(HttpURLConnection connection, String methodName, String[] parameterTypenames,
                              Object[] parameters) {
        try {
            Command command = new Command(methodName, parameterTypenames, parameters);
